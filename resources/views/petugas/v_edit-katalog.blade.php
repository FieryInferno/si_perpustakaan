              ...
              <div class="card card-primary card-outline card-outline-tabs">
                <div class="card-header p-0 border-bottom-0">
                  <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                    <li class="nav-item active">
                      <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-tabContent" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">Katalog</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card-body">
                  <div class="tab-content">
                    <div class="tab-pane fade show active" id="custom-tabs-four-tabContent" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                    ...
                    <div class="tab-pane fade show" id="custom-tabs-four-koleksi" role="tabpanel" aria-labelledby="custom-tabs-four-koleksi-tab">
