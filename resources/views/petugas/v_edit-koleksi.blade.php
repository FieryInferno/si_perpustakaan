...
<section class="content-header">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Edit Data Koleksi - {{$koleksi->id_buku}}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item " data-toggle="modal" data-target="#modal-danger"><a href="#"> &laquo; Kembali</a></li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-body">
                    <div class="col-md-12">
                        <form action="{{url('simpan-edit-koleksi')}}/{{$koleksi->id_buku}}" id="formtambah" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label text-md-right">Ganti Judul Buku</label>
                                <div class="col-md-6">
                                    <select class="custom-select" name="bib_id">
                                        <option value="{{$koleksi->bib_id}}" selected>{{$koleksi->bib_id}}
                                        </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control" type="date" id="tgl_pengadaan" value="{{$koleksi->tgl_pengadaan}}" name="tgl_pengadaan" />
                                    <div class="text-danger">
                                        @error('tgl_pengadaan')
                                        {{ $message }}
                                        @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="custom-select" name="jenis_sumber">
                                        <option value="{{$koleksi->jenis_sumber}}" selected>{{$koleksi->jenis_sumber}}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="nama_sumber" value="{{ $koleksi->nama_sumber }}" autocomplete="id_buku" autofocus>
                                    <div class="text-danger">
                                        @error('nama_sumber')
                                        {{ $message }}
                                        @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="custom-select" name="akses">
                                        <option value="{{$koleksi->akses}}" selected>{{$koleksi->akses}}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="custom-select" name="ketersediaan">
                                        <option value="{{$koleksi->ketersediaan}}" selected>{{$koleksi->ketersediaan}}</option>
    ...
    <div class="modal-dialog">
        <div class="modal-content bg-danger">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin tidak ingin mengubah data ini?</p>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-outline-light" data-dismiss="modal">Batal</button>
                <a class="btn btn-outline-light" href="{{route('koleksi')}}">Ok </a>
