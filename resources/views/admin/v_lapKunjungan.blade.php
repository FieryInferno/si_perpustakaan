...
<form action="{{ route('cetak-data-laporan-tgl') }}" method="GET">
    @csrf
        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <a href="{{route('cetak-data-kunjungan')}}" type="submit" class=" btn btn-primary" target="_blank">Cetak PDF Semua Data</a>
                </div>
                <div class="card-body">
